...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; Time tracking
     (wakatime :variables
               wakatime-api-key  "1a5ac34b-4d19-4aaa-a8fb-801ddf305e28"
...
before packages are loaded."
  ...
  (setq org-ellipsis "⤵")
  (setq org-tag-alist '(("@work" . ?w) ("@home" . ?h) ("@setup" . ?s) ("@travelling" . ?t) ("@email" . ?e) ("@admin" . ?a)))

  ;; org-capture
  (setq org-capture-templates '(("t" "Todo [inbox]" entry
                                 (file+headline "~/Documents/Git/org/inbox.org" "Captured")
                                 "* TODO %i%?")
                                ("T" "Tickler" entry
                                 (file+headline "~/Documents/Git/org/tickler.org" "Tickler")
                                 "* %i%? \n %U")))
  ...
  ;;   (shell-command-to-string "bash -c 'echo -n $(date "+%a %d %b %I:%M%p")'"))
